def calculation():
  ...
  while(True):
    ...
    if not  num1.isnumeric():
      ...
      if input("would you like to perform another calculation? y for yes n for no:  ") == "y":
    ...
    operator = input("Please enter  operation you wish to perform +, -, *, /: ")
    """User input"""
    ...
    if not num2.isnumeric():
      ...
      if input("would youlike to perform another calculation? y for yes n for no:  ") == "y":
